...
export function getAllCommands(context: CommandContext, searchValue = '', t?: TFunction): AppCommand[] {
  ...
  if (searchValue.trim() && t) {
    ...
    return allCommands.filter(cmd => {
      ...
      const description = cmd.descriptionKey ? t(cmd.descriptionKey).toLowerCase() : ''
