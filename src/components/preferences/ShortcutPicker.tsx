...
export function ShortcutPicker({ value, defaultValue, onChange, disabled = false, className }: ShortcutPickerProps) {
    ...
    <div className="flex items-center gap-2">
      ...
      >
        {isCapturing ? (
          ...
          <span className={isDefault ? 'text-muted-foreground' : ''}>{formatShortcutForDisplay(displayValue)}</span>
        )}
      </div>
